 ...
 * @since : 08 FEB 2023
 */
class SshAccess extends BaseController
{
    /**
    ...
    function sshAccessListing()
    {
        ...
        {        
            ...
            $data['sshAccessRecords'] = $this->sshaccess_model->sshAccessListing();
			
            $this->global['pageTitle'] = 'WorldTrack GPS : SSH Access Listing';
            
            $this->loadViews("back_end/sshAccess/sshAccess", $this->global, $data, NULL);
        }
    }
