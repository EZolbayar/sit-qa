                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-md-6"><a class="btn btn-sm btn-primary" href="<?php echo base_url() . 'vehicleListing' ?>" title="Back to Vehicles List"><i class="fa fa-backward"></i></a></div>
                        </div>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="cid" name="cid">
                                            ...
                                            ?>
                                                    <option value="<?php echo $cname->id ?>" <?php if ($cname->id == set_value('cid')) {
                                                                                                    echo "selected=selected";
                                                                                                } ?>><?php echo $cname->fullname ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
